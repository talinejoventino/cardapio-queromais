...
export const items: Item[] = [
  ...
  { id: "pz-100-calabresa", name: "Pizza calabresa 100g", description: "Pacote com 10 unidades. Cada unidade pesa 100 g.", priceCents: 4000, unit: "10un (100g)", categorySlug: "pizzas-brotinho", imageUrl: "/produtos/pizza-calabresa.JPG" },
  { id: "pz-100-frango", name: "Pizza frango 100g", description: "Pacote com 10 unidades. Cada unidade pesa 100 g.", priceCents: 4000, unit: "10un (100g)", categorySlug: "pizzas-brotinho", imageUrl: "/produtos/pizza-frango.JPG" },
  ...
  { id: "pz-130-calabresa", name: "Pizza calabresa 130g", description: "Pacote com 10 unidades. Cada unidade pesa 130 g.", priceCents: 4500, unit: "10un (130g)", categorySlug: "pizzas-brotinho", imageUrl: "/produtos/pizza-calabresa-130.JPG" },
  { id: "pz-130-frango", name: "Pizza frango 130g", description: "Pacote com 10 unidades. Cada unidade pesa 130 g.", priceCents: 4500, unit: "10un (130g)", categorySlug: "pizzas-brotinho", imageUrl: "/produtos/pizza-frango-130.JPG" },
  ...
  { id: "lan-croissant-frango", name: "Croissant de frango", description: "Pacote com 10 unidades. Cada unidade pesa 140 g.", priceCents:4000, unit: "10un", categorySlug: "lanches", imageUrl: "/produtos/croissant-frango.JPG" },
  { id: "lan-esfirra-carne", name: "Esfirra de carne", description: "Pacote com 10 unidades. Cada unidade pesa 140 g.", priceCents:4000, unit: "10un", categorySlug: "lanches", imageUrl: "/produtos/esfirra.JPG" },
  { id: "lan-esfirra-frango", name: "Esfirra de frango", description: "Pacote com 10 unidades. Cada unidade pesa 140 g.", priceCents:4000, unit: "10un", categorySlug: "lanches", imageUrl: "/produtos/esfirra.JPG" },
  { id: "lan-esfirra-mista", name: "Esfirra mista (queijo e presunto)", description: "Pacote com 10 unidades. Cada unidade pesa 140 g.", priceCents:4000, unit: "10un", categorySlug: "lanches", imageUrl: "/produtos/esfirra.JPG" },
  { id: "lan-pastel-frango", name: "Pastel de frango", description: "Pacote com 10 unidades. Cada unidade pesa 140 g.", priceCents:4000, unit: "10un", categorySlug: "lanches", imageUrl: "/produtos/pastel.JPG" },
  { id: "lan-pastel-queijo", name: "Pastel de queijo", description: "Pacote com 10 unidades. Cada unidade pesa 140 g.", priceCents:4000, unit: "10un", categorySlug: "lanches", imageUrl: "/produtos/pastel.JPG" },
  { id: "lan-pao-pizza-frango", name: "Pão pizza de frango", description: "Pacote com 10 unidades. Cada unidade pesa 140 g.", priceCents:4000, unit: "10un", categorySlug: "lanches", imageUrl: "/produtos/pao-pizza-frango.JPG" },
  { id: "lan-pao-pizza-misto", name: "Pão pizza misto", description: "Pacote com 10 unidades. Cada unidade pesa 140 g.", priceCents:4000, unit: "10un", categorySlug: "lanches", imageUrl: "/produtos/pao-pizza-misto.JPG" },
  { id: "lan-delicia-queijo", name: "Delícia de queijo", description: "Pacote com 10 unidades. Cada unidade pesa 140 g.", priceCents:4000, unit: "10un", categorySlug: "lanches", imageUrl: "/produtos/delicia-queijo.JPG" },
];
